...
public interface Items {
    ...
    Item[] SLIME_ARMOR = registerSet(new ExtendedArmorMaterial("slime")
            ...
            .piece(new ArmorPiece(ArmorPiece.LEGGINGS_LOWER).lower().translucent().texture("leggings"))
            .piece(new ArmorPiece(ArmorPiece.BODY_LOWER).upper().translucent().texture("body"))
            .piece(new ArmorPiece(ArmorPiece.LEGGINGS_MIDDLE).lower().translucent().texture("leggings"))
            .piece(new ArmorPiece(ArmorPiece.BODY_MIDDLE).upper().translucent().texture("body"))
            .piece(new ArmorPiece(ArmorPiece.LEGGINGS_UPPER).lower().translucent().texture("leggings"))
            .piece(new ArmorPiece(ArmorPiece.BODY_UPPER).upper().translucent().texture("body"))
