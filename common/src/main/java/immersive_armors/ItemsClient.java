...
public class ItemsClient {
    public static void setupPieces() {
        ...
        Quaternionf rotate = Axis.XP.rotationDegrees(90.0f);
        ...
        STEAMPUNK_ARMOR
                ...
                .head(new GearPiece<>(new GearModel("head", 5), "gear_small", -0.3f, -0.3f, 0.0f, -1.5f, Axis.YP.rotationDegrees(90.0f)))
                .chest(new GearPiece<>(new GearModel("leftArm", 5), "gear_small", 0.23f, 0.40f, 0.0f, -2.0f, Axis.YP.rotationDegrees(90.0f)))
