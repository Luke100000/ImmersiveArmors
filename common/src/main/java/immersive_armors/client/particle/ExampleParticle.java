package immersive_armors.client.particle;
...
public class ExampleParticle extends SpriteBillboardParticle {
    protected ExampleParticle(ClientWorld p_i232447_1_, double p_i232447_2_, double p_i232447_4_, double p_i232447_6_) {
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType particleType, ClientWorld world, double p_199234_3_, double p_199234_5_, double p_199234_7_, double p_199234_9_, double p_199234_11_, double p_199234_13_) {
            ExampleParticle heartparticle = new ExampleParticle(world, p_199234_3_, p_199234_5_ + 0.5D, p_199234_7_);
